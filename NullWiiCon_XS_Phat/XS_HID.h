...
#define BUTTONCAPTURE 17

#define BUTTONCOUNT 18
uint8_t buttonStatus[BUTTONCOUNT];

static uint8_t LeftX = 128;
static uint8_t LeftY = 128;
static uint8_t RightX = 128;
static uint8_t RightY = 128;

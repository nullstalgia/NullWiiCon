...
const USB_Descriptor_String_t PROGMEM ProductString = USB_STRING_DESCRIPTOR(L"NullWiiCon-S");

const USB_Descriptor_String_t PROGMEM ManufacturerStringX = USB_STRING_DESCRIPTOR(L"Nullstalgia");
const USB_Descriptor_String_t PROGMEM ProductStringX = USB_STRING_DESCRIPTOR(L"NullWiiCon-X");
